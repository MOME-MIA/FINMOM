...
export default function AdminPage() {
    ...
    if (!isLoaded || isLoading) {
        return (
            <div className="min-h-screen bg-black flex items-center justify-center">
                <div className="w-8 h-8 rounded-full border-t-2 border-[#14b8a6] animate-spin" />
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-black text-white p-6 sm:p-12 md:p-24 selection:bg-[#14b8a6]/30 selection:text-white relative">
            {/* Background elements to match Total Black */}
            <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#14b8a6]/5 rounded-full blur-[120px] mix-blend-screen opacity-50" />
                ...
                <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-16">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-4 bg-white/5 rounded-2xl p-2 px-6 border border-white/10 backdrop-blur-md">
                            ...
                            <div className="text-center">
                                <span className="block text-2xl font-bold text-[#14b8a6]">{approvedCount}</span>
                                <span className="text-[10px] uppercase tracking-wider text-[#14b8a6]/60">Aprobados</span>
                            </div>
                        </div>
                                                ...
                                                {entry.status === 'pending' && (
                                                    <div className="flex items-center justify-end gap-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className="px-4 py-2 rounded-lg text-xs font-semibold bg-[#14b8a6]/10 text-[#14b8a6] hover:bg-[#14b8a6]/20 border border-[#14b8a6]/20 transition-all shadow-[0_0_15px_rgba(191,90,242,0.15)]"
                                                        >
                                                            AUTORIZAR
                                                        </button>
                                                    </div>
