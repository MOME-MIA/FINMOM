                ...
                <div className="p-10 rounded-[32px] bg-white/[0.02] border border-white/[0.04] relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-3xl">
                        ...
                        <p className="text-[16px] text-white/50 leading-[1.8] font-medium mb-4">
                            En Momentum no buscamos gente que cumpla tareas — buscamos constructores obsesivos que quieran redefinir cómo funciona el dinero. Trabajamos remoto, en ciclos de impacto, con autonomía total y responsabilidad real.
                        </p>
